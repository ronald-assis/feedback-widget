...
import stylesFeedbackSuccessStep from './sytles.module.css';
...
export function FeedbackSuccessStep({ onFeedbackRestartRequested }: Props) {
  return (
    <>
      ...
      <div className={stylesFeedbackSuccessStep.messageSuccess}>
        ...
        <button
          className={stylesFeedbackSuccessStep.otherFeedback}
